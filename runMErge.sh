...
then
	...
	cp -r $KLESS_PATH/klessydra-t0-3th $PULP_PATH/ips
	...
	# T03x patched files
	cp -f $KLESS_PATH/patched_files/t03x_patched_files/cmake_configure.klessydra-t0-3th.gcc.sh $PULP_PATH/sw
	cp -f $KLESS_PATH/patched_files/t03x_patched_files/vcompile_klessydra-t0-3th.csh $PULP_PATH/vsim/vcompile
