...
------------------------------------------------------------------------------------------------------------
  ...
  constant THREAD_POOL_SIZE        : natural := 3; --will be passed to the generic THERAD_POOL_SIZE
  constant THREAD_POOL_SIZE_GLOBAL : natural := 3; -- Indicates the total number of harts on the chip, and not only the ones in the cores
  constant THREAD_POOL_BASELINE    : natural := 3; 
  constant THREAD_ID_SIZE          : natural := 4;
  constant NOP_POOL_SIZE           : natural := 2;
  ...
  type MSTATUS_array   is array (natural range THREAD_POOL_SIZE-1 downto 0) of std_logic_vector(1 downto 0);
  type MESTATUS_array  is array (natural range THREAD_POOL_SIZE-1 downto 0) of std_logic_vector(2 downto 0);
  type MCPUID_array    is array (natural range THREAD_POOL_SIZE-1 downto 0) of std_logic_vector(8 downto 0);
  type MIMPID_array    is array (natural range THREAD_POOL_SIZE-1 downto 0) of std_logic_vector(15 downto 0);
  type harc_array      is array (natural range THREAD_POOL_SIZE-1 downto 0) of std_logic;
  type buf_array_int   is array (natural range BUF_SIZE-1 downto 0) of integer;
  type harc_array_nat  is array (natural range BUF_SIZE-1 downto 0) of natural;
  type fw_buffer       is array (natural range BUF_SIZE-1 downto 0) of std_logic_vector(31 downto 0);
